...
var Shop_page = function (_BasePage) {
    _inherits(Shop_page, _BasePage);

    _createClass(Shop_page, [{
        key: 'name',
    ...
    function Shop_page() {
        _classCallCheck(this, Shop_page);

        var _this = _possibleConstructorReturn(this, (Shop_page.__proto__ || Object.getPrototypeOf(Shop_page)).call(this));

        _elements = new _shop2.default();
        return _this;
    }
